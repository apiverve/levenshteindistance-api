// Package levenshteindistance provides a Go client for the Levenshtein Distance API.
//
// For more information, visit: https://apiverve.com/marketplace/levenshteindistance?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Levenshtein Distance API.
//
// Parameters:
//   - string1 (required): string - First string to compare (max 10,000 characters)
//   - string2 (required): string - Second string to compare (max 10,000 characters)
type Request struct {
	String1 string `json:"string1"` // Required
	String2 string `json:"string2"` // Required
}
...
// ResponseData contains the data returned by the Levenshtein Distance API.
type ResponseData struct {
	Distance int `json:"distance"`
	Similarity float64 `json:"similarity"`
	String1Length int `json:"string1Length"`
	String2Length int `json:"string2Length"`
