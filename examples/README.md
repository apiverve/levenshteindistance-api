# Levenshtein Distance API - Examples

This folder contains example code for using the Levenshtein Distance API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/levenshteindistance',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/levenshteindistance](https://docs.apiverve.com/ref/levenshteindistance)
