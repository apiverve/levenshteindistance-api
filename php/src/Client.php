...
namespace APIVerve\Levenshteindistance;
...
/**
 * Client for the Levenshtein Distance API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/levenshteindistance?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/levenshteindistance';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LevenshteindistanceClient] {$message}\n";
        }
    }
}
