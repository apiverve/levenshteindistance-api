...
namespace APIVerve.API.LevenshteinDistance
{
    ...
    /// <summary>
    /// Client for the LevenshteinDistance API
    /// </summary>
    public class LevenshteinDistanceAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/levenshteindistance";
        ...
        {
            { "string1", new ValidationRule { Type = "string", Required = true } },
            { "string2", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public LevenshteinDistanceAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LevenshteinDistanceAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LevenshteinDistanceAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, LevenshteinDistanceQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(LevenshteinDistanceQueryOptions options)
        {
        ...
        public ResponseObj Execute(LevenshteinDistanceQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(LevenshteinDistanceQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(LevenshteinDistanceQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(LevenshteinDistanceQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(LevenshteinDistanceQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(LevenshteinDistanceQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(LevenshteinDistanceQueryOptions options)
        {
