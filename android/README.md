# Levenshtein Distance Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:levenshteindistance-api:1.1.14'
}
```
...
```java
import com.apiverve.levenshteindistance.LevenshteinDistanceAPIClient;
import com.apiverve.levenshteindistance.APIResponse;
import com.apiverve.levenshteindistance.APIException;

// Initialize the client
LevenshteinDistanceAPIClient client = new LevenshteinDistanceAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("string1", "kitten");
    parameters.put("string2", "sitting");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/levenshteindistance](https://docs.apiverve.com/ref/levenshteindistance)
...
- **Documentation:** [https://docs.apiverve.com/ref/levenshteindistance](https://docs.apiverve.com/ref/levenshteindistance)
- **Issues:** [GitHub Issues](https://github.com/apiverve/levenshteindistance-api/issues)
